...
if (playerHealth >= playerMaxHealth) {
	...
	part_emitter_region(dustParticle.dustParticleSystem, dustParticle.dust_emitter, id.x-25, id.x+25, id.y-25, id.y+25, ps_shape_ellipse, ps_distr_gaussian);
	part_emitter_burst(dustParticle.dustParticleSystem, dustParticle.dust_emitter, dustParticle.dust_particle, 1);
	//}
