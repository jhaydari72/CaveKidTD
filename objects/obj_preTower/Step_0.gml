...
if global.currency = true{
	if (mouse_check_button(mb_left)) {
		//show_debug_message("images clicked");
		with (obj_axe) {
			//towerNumber = 1;
			_axe = point_in_rectangle(mouse_x,mouse_y, x-25,y-60,x+25,y+60);
		}

		with (obj_jaw) {
			//towerNumber = 2;
			_jaw = point_in_rectangle(mouse_x, mouse_y, x-30,y-84,x+30,y+84);
		}

		with(obj_shield) {
			//towerNumber = 3;
			_shield = point_in_rectangle(mouse_x,mouse_y,x-50,y-52,x+50,y+52);
		}

		with(obj_rhino) {
			//towerNumber = 4;
			_rhino = point_in_rectangle(mouse_x,mouse_y,x-50,y-60,x+50,y+60);
		}
	
		_loc = point_in_circle(mouse_x,mouse_y,x,y,50);
...
if (_temp) {
	...
	kidId = instance_create_layer(917,380, "Instances", obj_PathFinder);
...
if (variable_instance_exists(kidId, "towerid"))
	{
		variable_instance_set(kidId, "towerid", tower);
	}
/*
